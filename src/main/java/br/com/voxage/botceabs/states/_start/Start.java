...
public class Start{
	...
	private static final String INITIAL_MESSAGE = "{" + 
	           "   \"message\":\"Olá Prestador! Bem-vindo a CEABS. Como eu posso te ajudar? Escolha uma das opções a seguir:\"," + 
	           "   \"options\":[" + 
	           "      {" + 
	           "         \"id\":1," + 
	           "         \"text\":\"Fechar Ordem de Serviço\"" + 
	           "      }," + 
	           "      {" + 
	           "         \"id\":2," + 
	...
	public static BotState load(BotCEABS bot) {
		return new BotState("/") {{
				...
				setPreFunction(botState -> {
					...
					//new BotMessage( JsonUtils.toJson( "Olá bem vindo a Ceabs. Vou transferir seu atendimento para um de nossos operadores. Por favor aguarde." ), MessageType.TEXT_ONLY);
